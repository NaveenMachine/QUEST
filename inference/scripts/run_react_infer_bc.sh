...
export DATASET="${DATASET:-${REPO_ROOT}/evaluation/browsecomp/browsecomp.jsonl}"
export OUTPUT_PATH="${OUTPUT_PATH:-${INFERENCE_DIR}/outputs/browsecomp/results}"
export TASK_LOG_DIR="${TASK_LOG_DIR:-${INFERENCE_DIR}/outputs/browsecomp/memory_logs}"
...
export HOSTNAME_LIST="${HOSTNAME_LIST:-your_endpoint}"
